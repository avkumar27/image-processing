//Motion estimation program using FAST + LUCID
...
int main( int argc, char** argv )
{
    ...
    Descriptor->compute(bgr_frame1, keypoints_1, descriptors_1);// computing descriptors for the corresponding keypoints using LUCID descriptor
    ...
    Descriptor-> compute(bgr_frame2, keypoints_2, descriptors_2); // computing descriptors for keypoints_2 using LUCID
    ...
    for(;;) // infinite loop
    {
        ...
        double max_dist = 0; double min_dist = 1000; //defining minimum and maximum distances
